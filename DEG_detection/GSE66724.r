...
my.pdata$type <- c("Control","Control","Control","Control","Control","Control","Control","Control","Stroke","Stroke","Stroke","Stroke","Stroke","Stroke","Stroke","Stroke")
...
pData(my.affy)$sample.levels <- c(rep("Control", 8), rep("Stroke", 8))
pData(my.affy)$sample.labels <- c(paste("Control", 1:8, sep="."), paste("Stroke", 1:8, sep="."))
...
updegs <- rownames(contrast.tests)[contrast.tests$`Control-Stroke` == 1]
downdegs <- rownames(contrast.tests)[contrast.tests$`Control-Stroke` == -1]
